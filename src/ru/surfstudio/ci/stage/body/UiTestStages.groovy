    ...
    def static testStageBody(Object script,
        ...
        script.echo "start tests for $artifactForTest $taskKey"
           ...
           //catch (NoArhives e){
            ...
            CommonUtil.shWithRuby(script, "set -x; source ~/.bashrc; adb kill-server; adb start-server; adb devices; parallel_calabash -a ${artifactForTest} -o \"-p ${platform} -f pretty -f html -o ${outputsDir}/${outputHtmlFile} -f json -p json_report\" ${featuresDir}/${featureFile} --concurrent")
