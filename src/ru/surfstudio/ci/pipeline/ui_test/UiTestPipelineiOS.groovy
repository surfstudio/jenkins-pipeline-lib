...
class UiTestPipelineiOS extends UiTestPipeline {
    ...
    def static buildStageBodyiOS(Object script, String sourcesDir, String derivedDataPath, String sdk, String keychainCredenialId, String certfileCredentialId) {
        script.withCredentials([
            ...
            script.sh "set +x; source ~/.bashrc; source ~/.rvm/scripts/rvm; rvm use 2.3.5; set -x; expect -f calabash-expect.sh"
            script.sh "xcodebuild -workspace ${sourcesDir}/*.xcworkspace -scheme MDK\ Debug-cal -allowProvisioningUpdates -sdk ${sdk} -derivedDataPath ${derivedDataPath}"
